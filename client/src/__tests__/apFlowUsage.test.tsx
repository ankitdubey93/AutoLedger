...
import ApFlowUsagePage from '../Pages/ap-flow/ApFlowUsagePage';
...
function renderPage() {
  return render(
    <MemoryRouter initialEntries={['/app/ap-flow/usage']}>
      <Routes>
        <Route path="/app/ap-flow/usage" element={<ApFlowUsagePage />} />
      </Routes>
    </MemoryRouter>,
  );
}

describe('ApFlowUsagePage', () => {
