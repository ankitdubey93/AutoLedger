...
import InvoiceDocument from '../Pages/ledger-core/InvoiceDocument';
import InvoiceTemplatePage from '../Pages/ledger-core/InvoiceTemplatePage';
import { SAMPLE_CUSTOMER_NAME, SAMPLE_INVOICE } from '../Pages/ledger-core/sampleInvoice';
...
async function renderEditor(scenario: Scenario = {}) {
  ...
  const view = render(
    <MemoryRouter initialEntries={['/app/ledger-core/settings/invoice-template']}>
      <AuthProvider>
        <OrgProvider>
          <Routes>
            <Route path="/app/:appSlug/settings/invoice-template" element={<InvoiceTemplatePage />} />
          </Routes>
        </OrgProvider>
      </AuthProvider>
    </MemoryRouter>,
