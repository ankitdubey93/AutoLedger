 ...
 * intake moved to the platform /integrations page in Phase 19.3; this page
 * now only links there (see integrationsDrive.test.tsx for that page's own
 * coverage).
 */
...
describe('ApFlowSettingsPage', () => {
  it('links to the platform Integrations page for Google Drive intake', async () => {
    mockRoutes();
    renderPage();
    ...
    expect(screen.getByText('Manage Drive folders').closest('a')).toHaveAttribute('href', '/integrations');
  });
