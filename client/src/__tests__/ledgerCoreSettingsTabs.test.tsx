...
import ChartSettingsPage from '../Pages/ledger-core/ChartSettingsPage';
import ConversionBalancesPage from '../Pages/ledger-core/ConversionBalancesPage';
import FinancialSettingsPage from '../Pages/ledger-core/FinancialSettingsPage';
...
describe('FinancialSettingsPage', () => {
  ...
  function renderPage() {
    return render(
      <MemoryRouter initialEntries={['/app/ledger-core/settings/financial']}>
        <Routes>
          <Route
            path="/app/:appSlug/settings/financial"
            element={
...
describe('ChartSettingsPage', () => {
  ...
  function renderPage() {
    return render(
      <MemoryRouter initialEntries={['/app/ledger-core/settings/chart']}>
        <Routes>
          <Route path="/app/:appSlug/settings/chart" element={<ChartSettingsPage />} />
        </Routes>
      </MemoryRouter>,
    );
  }
...
describe('ConversionBalancesPage', () => {
  ...
  function renderPage() {
    return render(
      <MemoryRouter initialEntries={['/app/ledger-core/settings/conversion-balances']}>
        <Routes>
          <Route
            path="/app/:appSlug/settings/conversion-balances"
            element={
              <LedgerSettingsProvider>
                <ConversionBalancesPage />
              </LedgerSettingsProvider>
