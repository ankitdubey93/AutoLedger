...
import PaymentTermsSettingsPage from '../Pages/ledger-core/PaymentTermsSettingsPage';
...
function renderSettingsPage() {
  return render(
    <MemoryRouter initialEntries={['/app/ledger-core/settings/payment-terms']}>
      <Routes>
        <Route path="/app/:appSlug/settings/payment-terms" element={<PaymentTermsSettingsPage />} />
      </Routes>
    </MemoryRouter>,
  );
}
