    ...
    <div className="space-y-6">
      ...
      <section aria-label="Products and services" className="space-y-2">
        ...
        {item.ledgerItemId !== null ? (
          <p className="text-sm text-[var(--muted)]">
            Linked to Products &amp; Services. Stock movements of this item post to your inventory account, and it can be bought on
              ...
              <tr key={m.id} className="border-t border-[var(--border)]">
                ...
                <td className="pr-3 py-1 text-[var(--muted)]">
                  {m.sourceType === 'bill' && m.sourceId !== null ? (
                    <Link to={`/bills/${m.sourceId}`} className="underline">
                      Bill
                    </Link>
                  ) : m.sourceType === 'invoice' && m.sourceId !== null ? (
                    <Link to={`/invoices/${m.sourceId}`} className="underline">
                      Invoice
                    </Link>
                  ) : m.glAccountId !== null ? (
                    'Posted to ledger'
