  ...
  if (notFound) {
    return (
      <section className="flex flex-col gap-4">
        <BackLink to={base} label="Back to bill inbox" />
    ...
    <section className="flex flex-col gap-5">
        ...
        <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/5 p-4 flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1">
            {document.journalEntryId !== null && (
              <p className="text-sm m-0">
                <Link to={`/journals/${document.journalEntryId}`} className="underline">
                  View journal entry
                </Link>
              </p>
            )}
            {document.billId !== null && (
              <p className="text-sm m-0">
                <Link to={`/bills/${document.billId}`} className="underline">
                  View expense
                </Link>
              </p>
            )}
      ...
      {confirmingPost && (
        <ConfirmDialog
          ...
          body="This creates a real journal entry in your books. It cannot be edited afterwards — a correction requires reversing the entry."
          confirmLabel="Post"
          busy={busy}
