...
<div className="min-h-screen bg-gray-100">
    <header className="bg-blue-600 text-white p-4 flex justify-between items-center">
        ...
        <button onClick={auth?.logout} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">SignOut</button>
        <nav>
        <ul>
          <li>
    ...
    <main className="container mx-auto p-4">
        <section className="bg-white p-4 rounded-md shadow-md mb-4">
            <h2 className="text-lg font-semibold mb-2">
                {auth?.username ? `Welcome, ${auth?.username}!` : `Welcome to your Dashboard!`}
            </h2>
