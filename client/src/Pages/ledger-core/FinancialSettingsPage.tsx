...
export default function FinancialSettingsPage() {
  ...
  // `ready` arm of the union (same pattern as SettingsPage).
  useEffect(() => {
    ...
    <section className="flex flex-col gap-6 max-w-xl">
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-sm m-0">
          <Link to={`${base}/settings/conversion-balances`}>Enter conversion balances</Link>
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm m-0">
          <Link to={`${base}/fiscal-periods`}>Manage fiscal periods</Link>
        </p>
      </div>
      ...
      {error !== null && (
        <p className="status status--bad">
          ...
          {needsOnboarding && (
            <>
              {' '}
              <Link to={`${base}/onboarding`}>Open the setup wizard</Link>
            </>
          )}
        </p>
      )}
