    ...
    >
      ...
      >
        ...
        <p className="text-xs text-[var(--muted)] m-0">
          Saved to Products &amp; Services and picked on this line. To track quantity, create a stock item in{' '}
          <a href="/app/stock/items/new" target="_blank" rel="noreferrer" className="underline">
            StockLedger
          </a>{' '}
          instead.
        </p>
