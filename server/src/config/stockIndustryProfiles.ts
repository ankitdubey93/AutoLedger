...
/**
 * StockLedger (Phase 28) — the ten industry starting points offered on
 * `POST /stock/setup`. Applying one (`setupService.applyIndustryProfile`)
 ...
 * mirrors `config/apps.ts`: `satisfies` checks every entry against the
