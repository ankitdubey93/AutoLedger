...
import type { Vendor } from '../../types/accounting.js';

/**
 * Accounting vendors — the parties bills are entered against.
 *
...
/**
 * Phase 19 — Capture's captured-bill posting needs a vendor id from an
