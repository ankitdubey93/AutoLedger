...
/**
 * Accounting invoice settings — numbering, defaults, and branding.
 *
...
/** GET /settings/invoicing. No row is not a 404 — it means "never configured". */
...
/** PATCH /settings/invoicing. Creates the row on first write. */
