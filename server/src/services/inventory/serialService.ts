...
import type { StockAttributes, StockSerial, StockSerialStatus } from '../../types/inventory.js';
 ...
 * FSM transition table lives in types/inventory.ts, and every status change in
