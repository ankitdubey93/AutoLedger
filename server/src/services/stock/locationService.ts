...
import { STOCK_TOP_LEVEL_LOCATION_KINDS } from '../../types/stock.js';
import type { StockLocation, StockLocationKind } from '../../types/stock.js';

/**
 * StockLedger (Phase 28) — the location hierarchy: warehouse/store/site at
