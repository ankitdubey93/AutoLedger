...
import { CODE_SCHEME_PRESETS } from '../../config/stockIndustryProfiles.js';
import type { StockCodeScheme } from '../../types/stock.js';

/**
 * StockLedger (Phase 28) — item-code schemes and their per-scope counters.
 *
