import type { ApFlowAutoPostBlocker, ApFlowMappingSource, ApFlowSettings } from '../../types/ap-flow.js';

/**
 * AP-Flow's auto-post gate (Phase 19) — pure, no database, no network.
...
export function evaluateAutoPost(candidate: AutoPostCandidate, settings: ApFlowSettings): ApFlowAutoPostBlocker[] {
  ...
  const blockers: ApFlowAutoPostBlocker[] = [];
