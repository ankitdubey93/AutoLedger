/**
 * Inventory types — Phase 28.
 *
 * App-prefixed (`Stock*`), mirroring `types/accounting.ts` and
...
export interface StockItem {
  ...
  /** Phase 32: the Accounting product (items.id) this stock item is linked to; null = unlinked, posts no GL. */
