...
import * as creditNoteService from '../../services/ledger-core/creditNoteService.js';
import {
...
} from '../../schemas/ledger-core/creditNoteSchema.js';
...
import { isNoteStatus, type NoteStatus } from '../../types/ledger-core.js';
...
/** POST /ledger-core/credit-notes — a DRAFT against an issued invoice. */
...
/** POST /ledger-core/credit-notes/:id/issue */
...
/** POST /ledger-core/credit-notes/:id/void */
...
/** POST /ledger-core/credit-notes/:id/allocations — apply unapplied credit to an open invoice. */
