...
import * as debitNoteService from '../../services/ledger-core/debitNoteService.js';
import {
  ...
  voidDebitNoteSchema,
} from '../../schemas/ledger-core/debitNoteSchema.js';
...
/** POST /ledger-core/debit-notes — a DRAFT against an approved bill. */
...
/** POST /ledger-core/debit-notes/:id/issue */
...
/** POST /ledger-core/debit-notes/:id/void */
...
/** POST /ledger-core/debit-notes/:id/allocations — apply unapplied credit to an open bill. */
