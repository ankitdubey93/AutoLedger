...
import * as movementService from '../../services/inventory/movementService.js';
import * as stockQueryService from '../../services/inventory/stockQueryService.js';
import { adjustmentSchema, issueSchema, receiptSchema, transferSchema } from '../../schemas/inventory/movementSchema.js';
...
import { isStockMovementType, isStockSerialStatus } from '../../types/inventory.js';
import type { StockMovementType, StockSerialStatus } from '../../types/inventory.js';
...
/** GET /inventory/product-balances — on-hand per Accounting product id, for the Products & Services list and line pickers. */
