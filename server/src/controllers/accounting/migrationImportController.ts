...
import * as migrationImportService from '../../services/accounting/migrationImportService.js';
import {
  createMigrationImportSchema,
  patchMigrationRowSchema,
} from '../../schemas/accounting/migrationImportSchema.js';
import { parseBody } from '../../utils/parseBody.js';
import { requireUser } from '../../utils/requireUser.js';
import { requireParam } from '../../utils/routeParam.js';
import { readPagination } from '../../utils/queryParam.js';
import { ApiError } from '../../utils/apiError.js';
import { isMigrationImportKind, isMigrationRowStatus } from '../../types/accounting.js';
...
/** PATCH /migration-imports/:id/rows/:rowId */
...
/** POST /migration-imports/:id/validate */
...
/** GET /migration-imports/:id/preview */
...
/** POST /migration-imports/:id/commit — OWNER/ADMIN only. */
