...
import * as customerService from '../../services/accounting/customerService.js';
import { createCustomerSchema, updateCustomerSchema } from '../../schemas/accounting/customerSchema.js';
...
/** GET /customers/:id/ledger — the party's account under the control account (Phase 25). */
...
/** GET /customers/:id/open-items?asOf=YYYY-MM-DD */
