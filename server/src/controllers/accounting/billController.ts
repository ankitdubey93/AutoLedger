...
import * as billService from '../../services/accounting/billService.js';
import {
  approveBillSchema,
  createBillSchema,
  submitBillSchema,
  updateBillSchema,
  voidBillSchema,
} from '../../schemas/accounting/billSchema.js';
...
import { isBillStatus, type BillStatus } from '../../types/accounting.js';
