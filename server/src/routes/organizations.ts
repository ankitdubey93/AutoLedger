...
router.get('/profile', authenticate, organizationProfileController.get);

// Editing it is organization configuration, same tier as PATCH / above.
router.patch(
  '/profile',
  authenticate,
  requireRole('OWNER', 'ADMIN'),
  organizationProfileController.update,
);
