...
import * as movementController from '../../controllers/stock/movementController.js';
import { authenticate } from '../../middleware/auth.js';
import { requireRole } from '../../middleware/rbac.js';

/**
 * /api/v1/stock/receipts, /issues, /transfers, /adjustments, /balances,
 ...
 * itemRoutes.ts — `routes/stock/index.ts` mounts this router BEFORE
