...
/**
 * Inventory (Phase 28) — setup: choosing and applying an industry
...
const app = createApp();
const SETTINGS = '/api/v1/inventory/settings';
const PROFILES = '/api/v1/inventory/setup/profiles';
const SETUP = '/api/v1/inventory/setup';
const LEDGER_ONBOARDING = '/api/v1/settings/onboarding';
...
/** A minimal, always-valid Accounting onboarding payload, mirroring ledger-core/settings.test.ts. */
...
describe('GET /inventory/settings', () => {
  ...
  it('suggests from the Accounting industry', async () => {
    const agent = await loginAgent(app, userA);
...
describe('GET /inventory/setup/profiles', () => {
