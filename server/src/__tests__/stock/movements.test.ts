...
/**
 * StockLedger (Phase 28) — the movement write path: receipts, issues,
...
const TRANSFERS = '/api/v1/stock/transfers';
const ADJUSTMENTS = '/api/v1/stock/adjustments';
const BALANCES = '/api/v1/stock/balances';
const MOVEMENTS = '/api/v1/stock/movements';
const SUMMARY = '/api/v1/stock/summary';
