...
import { createCapturedBillOnClient, approveBillOnClient } from '../../services/accounting/billService.js';
import { findOrCreateVendorByNameOnClient, createVendor } from '../../services/accounting/vendorService.js';

/**
 * Phase 19's Accounting additions Capture's postingService.ts calls on its
...
describe('Accounting captured-bill posting (Phase 19)', () => {
  beforeEach(async () => {
    await resetTables();
