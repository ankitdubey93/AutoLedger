...
/**
 * Accounting — bills (Phase 3.9). Integration tier, real PostgreSQL.
 *
...
describe('POST /bills/:id/approve', () => {
...
describe('POST /bills/:id/void', () => {
  it('on a posted bill posts a mirror reversal and rebalances the trial balance', async () => {
    ...
    const trialBalanceRes = await agent.get('/api/v1/reports/trial-balance');
...
describe('GET /bills — filtering and isolation', () => {
...
describe('GET /bills — ?settlement= filter', () => {
