...
/**
 * Accounting — payments (Phase 3.9). Integration tier, real PostgreSQL.
 *
...
describe('POST /payments — RECEIVE', () => {
...
describe('trial balance stays balanced through payment activity', () => {
  it('after a partial RECEIVE and a full PAY', async () => {
    ...
    const trialBalanceRes = await agentA.get('/api/v1/reports/trial-balance');
