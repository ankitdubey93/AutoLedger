...
/**
 * Accounting — sales invoices (Phase 3.8). Integration tier, real PostgreSQL.
 *
...
describe('PATCH and DELETE /invoices/:id — draft only', () => {
...
describe('GET /invoices — filtering and isolation', () => {
...
describe('GET /invoices — ?settlement= filter', () => {
