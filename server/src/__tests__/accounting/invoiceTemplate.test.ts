...
/**
 * Accounting — invoice template settings (Phase 30). Integration tier, real
...
const app = createApp();
const INVOICE_SETTINGS = '/api/v1/settings/invoicing';
...
describe('GET /settings/invoicing — template defaults', () => {
...
describe('PATCH /settings/invoicing — template fields', () => {
