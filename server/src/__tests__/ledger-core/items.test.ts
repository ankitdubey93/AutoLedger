...
/**
 * LedgerCore — items (Phase 24). Integration tier, real PostgreSQL.
 *
...
const app = createApp();
const BASE = '/api/v1/ledger-core/items';
...
describe('POST /ledger-core/items', () => {
...
describe('PATCH /ledger-core/items/:id', () => {
...
describe('GET /ledger-core/items', () => {
