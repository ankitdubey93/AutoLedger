...
/**
 * PUT /capture/settings — Phase 19's auto-post gates. `autoPostMinConfidence`
...
export type UpdateCaptureSettingsInput = z.infer<typeof updateCaptureSettingsSchema>;
