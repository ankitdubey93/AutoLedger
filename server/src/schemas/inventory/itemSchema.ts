import { z } from 'zod';
import { STOCK_TRACKING_MODES } from '../../types/inventory.js';
import { ITEM_CODE_REGEX } from '../../utils/stockCodePattern.js';

/**
 * Request schemas for Inventory items. `code`, `categoryId`, `itemType`,
...
/**
 * Phase 32: the accounting side of the Accounting product a stock item is
