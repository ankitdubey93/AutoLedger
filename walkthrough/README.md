...
A complete, three-month accounting scenario for LedgerCore — a vendor and a customer CSV to import, source documents to enter by hand, three bank statements to import, and a computed answer key to check your work against.
