...
| **4** | LedgerCore — live statements: P&L, balance sheet, fiscal periods with close/lock, AR/AP subledgers — computed from raw `ledger_lines`, **no pre-calculated summary tables** | Needs 3 |
