...
| Finite state machines for document lifecycle | 3.8 (invoices), 3.9 (bills — four states, a recall edge, role-gated approval), 4 (fiscal periods — a genuinely terminal state) | ✅ |
