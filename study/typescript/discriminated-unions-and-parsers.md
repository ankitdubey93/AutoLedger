...
- `server/src/utils/uniteconPvm.ts`, `server/src/utils/forecasterBuild.ts` — the two earlier pure-calculation modules following the same no-throw convention (pre-dating this note)
